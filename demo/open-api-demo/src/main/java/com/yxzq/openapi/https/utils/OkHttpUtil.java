...
//        clientBuilder.addInterceptor(new HttpLogInterceptor());
     ...
     * @throws IOException
     */
    public String postData(String url, String bodyParams, Map<String, String> headerMap) throws Exception {

        //string 转换成json
        JSONObject parseObject = JSONArray.parseObject(bodyParams);

        //1构造RequestBody
        RequestBody body = setRequestBody(parseObject, headerMap);
        //2 构造Request
